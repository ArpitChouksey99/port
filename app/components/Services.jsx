...
const Services = () => {
  return (
    ...
    transition={{delay:0.7,duration:0.5}}
      className='text-center max-w-xl mx-auto mt-5 mb-12 font-Ovo'>I provide modern web development solutions focused on performance, scalability, and user experience. From responsive frontend interfaces to robust backend systems, I build applications that are fast, reliable, and tailored to real-world needs.</motion.p>
